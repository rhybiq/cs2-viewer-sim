...
from PySide6.QtWidgets import (
    ...
    QMainWindow, QMenu, QProgressBar, QPushButton, QStackedLayout, QTableView, QVBoxLayout,
    QWidget,
)
...
from demo_highlights.highlights import find_highlights_from_demo
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        version = get_current_version() or "dev build"
    ...
    def _start_scan(self):
        ...
        self._thread = CallableThread(find_highlights_from_demo, self._demo_path, top_n=DEFAULT_TOP_N)
    ...
    def _scan_done(self, result):
        ...
        self.status_message.setText(
            ...
            f"in {demo_name} ({result.map_name}, {result.total_rounds} rounds) in {elapsed:.1f}s")
